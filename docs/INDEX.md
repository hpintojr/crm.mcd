...
- [Service Cadence Cron](./SERVICE_CADENCE_CRON.md) — scheduled cadence check-in cases, dedupe/idempotency contract, gating, and the staged SERVICE_CADENCE enum migration.
