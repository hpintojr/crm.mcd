...
|---|---|---|---|
| Leads | `LEADS_ENABLED` | Controlled lead import, review, Cold Lead activity-first workspace, two-way-contact claim gate, DNC, aging sweep, warm replies, GHL relays, acceptance board | Controlled test window only after owner approval |
...
4. Execute Lead acceptance steps: import, review, Cold Lead activity, no-claim-before-contact boundary, DNC, claim after two-way contact, Open Pool return, aging sweep, GHL appointments, opportunity results, and inbound replies.
