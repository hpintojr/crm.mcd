...
/**
 * Provider-neutral JSON response shapes for the future paid-data import API.
 *
 * These schemas contain no route, database, secret, or persistence behavior.
 * They give the future local client and Admin review surface a shared result
 * contract before durable import tables are introduced.
 */
...
export const leadImportRecordDecisionSchema = z.object({
  ...
  idempotencyKey: leadImportIdentifierSchema.max(256),
