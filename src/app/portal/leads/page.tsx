...
export default async function LeadsPage() {
  ...
  const [available, mine] = await Promise.all([
    db.lead.findMany({
      where: { ownerAgentId: null, lifecycle: "AVAILABLE", pool: "OPEN", openPoolReleaseAt: { lte: now }, dnc: false, suppressed: false },
      orderBy: [{ openPoolReleaseAt: "asc" }, { score: "desc" }, { createdAt: "asc" }],
      take: 100,
    }),
