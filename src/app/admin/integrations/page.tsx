...
function suggestedResolutionNote(source: string, message: string) {
  ...
  if (source === "ghl.replies") {
    return "Resolved after reviewing the inbound reply payload, matching identifier, and Lead safety state. Retested with a controlled reply event; historical failed event was not replayed.";
  }
