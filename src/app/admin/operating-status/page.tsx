  ...
  const phases: Phase[] = [
    {
      ...
      detail:
        "PR #34 through PR #41 are deployed. Custom-domain smoke passed. The next gate is authenticated production acceptance for activity-first Cold Leads, two-way-contact claim rules, 45-day timers, DNC blackout, Warm Reply timer alignment, GHL relay hardening, and controlled aging sweep evidence.",
      next: "Record the controlled production Lead Flow acceptance results, review the Lead acceptance report, then record the owner decision before expanding normal agent use or external GHL workflow activation.",
