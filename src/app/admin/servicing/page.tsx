...
export default async function AdminServicingPage() {
  ...
  const [accounts, cases] = await Promise.all([listAdminServicingAccounts(), listOpenServiceCases()]);
