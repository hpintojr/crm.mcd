      ...
      <section className="mt-8 space-y-4">
        {gaps.allClear ? (
          <article className="rounded-2xl border border-emerald-800 bg-emerald-950/20 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-emerald-100/80">Use the acceptance overview, handoff packet, evidence matrix, closed-gates view, and command center for final review. This gaps page remains read-only.</p>
          </article>
        ) : (
          gaps.gaps.map((gap) => (
