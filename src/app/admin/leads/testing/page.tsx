  ...
  async function recordAcceptance(formData: FormData) {
    ...
    await db.auditLog.create({
      data: {
        ...
        entityId: step.id,
        reason: note,
        metadata: { module: "LEADS", phase: ACCEPTANCE_PHASE, statusBaselineCommit: STATUS_BASELINE_COMMIT, outcome, stepId: step.id, stepTitle: step.title },
      },
    });
