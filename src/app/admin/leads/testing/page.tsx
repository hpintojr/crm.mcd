...
const steps: Step[] = [
  { id: "controlled-test-setup", title: "1. Confirm controlled test setup", detail: "Use test agents and test records only. Keep the Lead module gated until the owner intentionally opens a controlled test window.", href: "/admin/operating-status", action: "Review gate state" },
  ...
  { id: "ghl-attribution", title: "9. Validate GHL handoff and appointment attribution", detail: "Confirm the demo-booked handoff stores the GHL Contact ID. When the MiniCRM Lead ID custom field is configured, confirm the appointment webhook also carries mini_crm_lead_id. Booked/Confirmed/Rescheduled retain ownership and Demo Booked; Cancelled/No-show create a same-owner follow-up.", href: "/admin/leads/handoff", action: "Open GHL handoff" },
