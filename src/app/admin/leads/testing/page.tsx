...
const steps: Step[] = [
  ...
  { id: "ghl-attribution", title: "9. Validate GHL handoff, appointments, and opportunity results", detail: "Confirm handoff stores the GHL Contact ID. Test appointment Booked, Confirmed, Rescheduled, Cancelled, and No-show behavior. Then test Opportunity Won to move a matched Lead to Closed Won, Opportunity Lost to move an open Lead to Closed Lost, a late Lost event that must not undo Closed Won, and a suppressed Lead that must not be changed.", href: "/admin/integrations", action: "Open integration monitor" },
