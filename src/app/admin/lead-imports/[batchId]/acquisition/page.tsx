  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-12">
      ...
      <section className="mt-6 rounded-2xl border border-amber-800/70 bg-ink-900 p-6">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-white">Acquisition provenance</h1>
        <p className="mt-3 text-sm text-gray-400">This record is intentionally excluded from shared lead screens, import review, and audit views.</p>
        <dl className="mt-6 grid gap-4 text-sm sm:grid-cols-2">
          ...
          <div><dt className="text-gray-500">Provider</dt><dd className="mt-1 text-gray-200">{provenance.providerName ?? "Not recorded"}</dd></div>
